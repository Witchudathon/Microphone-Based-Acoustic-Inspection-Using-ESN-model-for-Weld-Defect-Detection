#!/usr/bin/env python3
# ==============================================================================
# train_rf.py — Random Forest Experiment (FFT / HighPass / LowPass)
# Usage:  cd Project && python train_rf.py
#
# Output per preprocessing → Processing/<filter>/RandomForest/output/
