#!/usr/bin/env python3
# ==============================================================================
# train_xgboost.py — XGBoost Experiment (FFT / HighPass / LowPass)
# Usage:  cd Project && python train_xgboost.py
#
# Output per preprocessing → Processing/<filter>/XGBoost/output/
#   metrics.json | confusion_matrix.png | classification_report.txt
#   train_report.txt | model.joblib
#
...
from common import (
    ALL_CLASSES, LABELS_CSV, SEED, HAS_XGBOOST,
